...
## Cierre
- 2026-05-29: se cierra administrativamente durante reconstruccion de estado. El flujo `json3`/`importFromJson` quedo tratado como estabilizado dentro del cierre global de sincronizacion.
