...
- [x] Ningún formulario de la lista falla con `no such column: id` al guardar.
...
- [x] El flujo "editar presión sistólica y guardar" persiste localmente sin error.
...
## Bitácora de avance
- 2026-04-19: checkpoint de rama aplicado para publicación remota y continuidad de pruebas de campo.
- 2026-04-19: cierre de tarea tras hardening de repositorio y formularios críticos de control/antecedentes.
