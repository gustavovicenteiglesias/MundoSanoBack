...
- [ ] **Backend**: Definir y exponer endpoint incremental (por ejemplo `/data/json3/partial`) con filtro por fecha de última sincronización (`since`) o versión equivalente.
...
- [ ] **Frontend**: Ajustar flujo de inicio para decidir entre bootstrap full o sincronización parcial según existencia de DB local.
